...
class ProfesorController extends Controller
{
  ...
  public function mostrarProfesorAction()
  {
    ...
    return $this->render('GestorFCTBundle:Default:Profesor_tabla.html.twig',array("profesor"=>$profesor)); //Envia los datos a la vista
  }
  ...
  public function formularioProfesorAction(Request $request)
  {
    ...
    if( $form->isSubmitted() && $form->isValid()){ // Compueva que los datos esten enviados y sean validos
      ...
      return $this->redirectToRoute('profesor_tabla'); // Te envia a la ruta que le pones
    }

    return $this->render('GestorFCTBundle:Default:Profesor_form.html.twig',array('formulario'=>$form->createView()));
  }
