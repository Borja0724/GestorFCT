    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/gestor')) {
            ...
            if (0 === strpos($pathinfo, '/gestor/profesor')) {
                ...
                // profesor_form
                if ($pathinfo === '/gestor/profesor/new') {
                    return array (  '_controller' => 'GestorFCTBundle\\Controller\\ProfesorController::formularioProfesorAction',  '_route' => 'profesor_form',);
                }

                // profesor_api
                if ($pathinfo === '/gestor/profesor/api') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_profesor_api;
                    }

                    return array (  '_controller' => 'GestorFCTBundle\\Controller\\ProfesorController::proferosesApiAction',  '_route' => 'profesor_api',);
                }
                not_profesor_api:
