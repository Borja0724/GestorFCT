 ...
 */
class Profesores extends \GestorFCTBundle\Entity\Profesores implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestorFCTBundle\\Entity\\Profesores' . "\0" . 'id', '' . "\0" . 'GestorFCTBundle\\Entity\\Profesores' . "\0" . 'nombre', '' . "\0" . 'GestorFCTBundle\\Entity\\Profesores' . "\0" . 'apellidos', '' . "\0" . 'GestorFCTBundle\\Entity\\Profesores' . "\0" . 'departamento', '' . "\0" . 'GestorFCTBundle\\Entity\\Profesores' . "\0" . 'alumnos'];
        }
