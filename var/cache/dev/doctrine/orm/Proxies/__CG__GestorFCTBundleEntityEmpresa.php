...
namespace Proxies\__CG__\GestorFCTBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Empresa extends \GestorFCTBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'nombre', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'direccion', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'cp', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'telefono1', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'telefono2', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'fechaCreacion', '' . "\0" . 'GestorFCTBundle\\Entity\\Empresa' . "\0" . 'alumnos'];
        }
